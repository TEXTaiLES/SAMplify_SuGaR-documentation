...
<p style="text-align: justify; text-justify: inter-word;">
The pipeline is split across two branches: <b>nefele-training</b>, which runs SAM2, COLMAP, 
and SuGaR/PGSR as Docker containers on a GPU machine, and <b>nefele_ui</b>, a browser-based 
interface for uploading images, annotating, and downloading the final mesh. Both components 
can run together locally or through the HESTIA platform.
</p>
